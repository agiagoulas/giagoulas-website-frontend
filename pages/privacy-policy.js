...
export default function About() {
    return (
        <Layout currentPage="Privacy Policy" title="Privacy Policy">
            <TextPage title="Privacy Policy | Datenschutzerklärung">
                <div className="mx-auto w-2/3">
                    ...
                    <h3 className="font-semibold mt-4">Datenerfassung auf dieser Website</h3>
                    ...
                    <h3 className="font-semibold mt-4">Amazon Web Services (AWS)</h3>
                    <p>
                    ...
                    <h2 className="text-lg font-semibold mt-4">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                    <h3 className="font-semibold mt-4">Datenschutz</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Hinweis zur verantwortlichen Stelle</h3>
                    <p>
                    ...
                    <p>
                        Telefon: +49 162 2579704<br />
                        E-Mail: alexander.giagoulas@outlook.com
                    </p>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Speicherdauer</h3>
                    <p>
                        Soweit innerhalb dieser Datenschutzerkl&auml;rung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck f&uuml;r die Datenverarbeitung entf&auml;llt. Wenn Sie ein berechtigtes L&ouml;schersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gel&ouml;scht, sofern wir keine anderen rechtlich zul&auml;ssigen Gr&uuml;nde f&uuml;r die Speicherung Ihrer personenbezogenen Daten haben (z.&nbsp;B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die L&ouml;schung nach Fortfall dieser Gr&uuml;nde.
                    </p>
                    <h3 className="font-semibold mt-4">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
                    <p>
                        Wir verwenden unter anderem Tools von Unternehmen mit Sitz in den USA oder sonstigen datenschutzrechtlich nicht sicheren Drittstaaten. Wenn diese Tools aktiv sind, k&ouml;nnen Ihre personenbezogene Daten in diese Drittstaaten &uuml;bertragen und dort verarbeitet werden. Wir weisen darauf hin, dass in diesen L&auml;ndern kein mit der EU vergleichbares Datenschutzniveau garantiert werden kann. Beispielsweise sind US-Unternehmen dazu verpflichtet, personenbezogene Daten an Sicherheitsbeh&ouml;rden herauszugeben, ohne dass Sie als Betroffener hiergegen gerichtlich vorgehen k&ouml;nnten. Es kann daher nicht ausgeschlossen werden, dass US-Beh&ouml;rden (z.&nbsp;B. Geheimdienste) Ihre auf US-Servern befindlichen Daten zu &Uuml;berwachungszwecken verarbeiten, auswerten und dauerhaft speichern. Wir haben auf diese Verarbeitungst&auml;tigkeiten keinen Einfluss.</p><h3 className="font-semibold mt-4">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3> <p>Viele Datenverarbeitungsvorg&auml;nge sind nur mit Ihrer ausdr&uuml;cklichen Einwilligung m&ouml;glich. Sie k&ouml;nnen eine bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtm&auml;&szlig;igkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unber&uuml;hrt.
                    </p>
                    <h3 className="font-semibold mt-4">Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Auskunft, L&ouml;schung und Berichtigung</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                    <p>
                    ...
                    <h3 className="font-semibold mt-4">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
                    <p>
                        Diese Seite nutzt aus Sicherheitsgr&uuml;nden und zum Schutz der &Uuml;bertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschl&uuml;sselung. Eine verschl&uuml;sselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von &bdquo;http://&ldquo; auf &bdquo;https://&ldquo; wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.</p> <p>Wenn die SSL- bzw. TLS-Verschl&uuml;sselung aktiviert ist, k&ouml;nnen die Daten, die Sie an uns &uuml;bermitteln, nicht von Dritten mitgelesen werden.
                    </p>
                    <h2 className="text-lg font-semibold mt-4">4. Datenerfassung auf dieser Website</h2>
                    <h3 className="font-semibold mt-4">Anfrage per E-Mail, Telefon oder Telefax</h3>
                    <p>
